...
const epify = function (stringa) {
  if (stringa.slice(0, 7) !== "EPICODE") {
    let nome = "EPICODE" + stringa
    return nome
  } else {
    return stringa
  }
}
console.log(epify("EPICODEmario"))
/* ESERCIZIO 6
...
console.log(upperFirst("mario è scappato"))
...
const cutString = function (stringa) {
  let lessFirtsLast = stringa.slice(1, -1)
  return lessFirtsLast
}
console.log(cutString("roberto"))
/* ESERCIZIO 10
